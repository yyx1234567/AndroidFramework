...
namespace ETModel
{
    ...
    public class ICoroutineAdapter : CrossBindingAdaptor
    {
        ...
        {
            get { return new Type[] { typeof(IEnumerator<object>), typeof(System.Collections.IEnumerator), typeof(IDisposable) }; }
        }
        ...
        class Adaptor : IEnumerator<object>, System.Collections.IEnumerator, IDisposable, CrossBindingAdaptorType
        {
            ILTypeInstance instance;
