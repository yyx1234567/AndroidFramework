...
namespace ETModel {
  ...
  public partial class M2C_CreateRooms : pb::IMessage {
    private static readonly pb::MessageParser<M2C_CreateRooms> _parser = new pb::MessageParser<M2C_CreateRooms>(() => (M2C_CreateRooms)MessagePool.Instance.Fetch(typeof(M2C_CreateRooms)));
    public static pb::MessageParser<M2C_CreateRooms> Parser { get { return _parser; } }
    ...
    private static readonly pb::FieldCodec<global::ETModel.roominfo> _repeated_units_codec
        = pb::FieldCodec.ForMessage(10, global::ETModel.roominfo.Parser);
    private pbc::RepeatedField<global::ETModel.roominfo> units_ = new pbc::RepeatedField<global::ETModel.roominfo>();
    public pbc::RepeatedField<global::ETModel.roominfo> Units {
      get { return units_; }
      set { units_ = value; }
    }
  ...
  public partial class Frame_MoveUnit : pb::IMessage {
    private static readonly pb::MessageParser<Frame_MoveUnit> _parser = new pb::MessageParser<Frame_MoveUnit>(() => (Frame_MoveUnit)MessagePool.Instance.Fetch(typeof(Frame_MoveUnit)));
    public static pb::MessageParser<Frame_MoveUnit> Parser { get { return _parser; } }
  ...
  public partial class M2C_Disconnect : pb::IMessage {
    private static readonly pb::MessageParser<M2C_Disconnect> _parser = new pb::MessageParser<M2C_Disconnect>(() => (M2C_Disconnect)MessagePool.Instance.Fetch(typeof(M2C_Disconnect)));
    public static pb::MessageParser<M2C_Disconnect> Parser { get { return _parser; } }
