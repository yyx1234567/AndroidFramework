...
namespace ETHotfix
{
    ...
    public sealed class UI : Entity
    {
        ...
        public UnityEngine.UI.GraphicRaycaster graphicRaycaster { get; set; }
        ...
        public void Awake(string name, GameObject gameObject)
        {
            ...
            this.Canvas = gameObject.GetComponent<UnityEngine.Canvas>();
            graphicRaycaster = gameObject.GetComponent<UnityEngine.UI.GraphicRaycaster>();
        }
