...
namespace ETHotfix
{
    ...
    public class ZoomInput : IInputControl
    {
        ...
        {
             _deltaZ = -mouseScrollDelta.y * 0.1f;
        }


        public void UpdatInput(Transform camera, Transform target, Collider collider)
        {
            //_deltaZ = Mathf.Lerp(_deltaZ, 0, Time.deltaTime * InputParameter.ZoomSpeed);
            var prez = InputParameter.SummationZ;
            ...
            {
                InputParameter.SummationZ = prez;
             }
        }
